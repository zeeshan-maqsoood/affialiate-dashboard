...
export default function AnalyticsDashboard() {
    ...
    async function fetchAllData() {
        try {
            ...
            const kpiRes = await fetch(`https://z61mbrbz88.execute-api.eu-north-1.amazonaws.com/api/kpi-strip?${params.toString()}`);
            const kpiJson = await kpiRes.json();
            setKpiData(kpiJson);

            // Fetch for summary cards
            const trafficSummaryRes = await fetch(`https://z61mbrbz88.execute-api.eu-north-1.amazonaws.com/api/traffic-summary?${params.toString()}`);
            ...
            const trafficChartRes = await fetch(`https://z61mbrbz88.execute-api.eu-north-1.amazonaws.com/api/traffic-daily?${params.toString()}`);
            ...
            const purchasesRes = await fetch(`https://z61mbrbz88.execute-api.eu-north-1.amazonaws.com/api/purchases?${params.toString()}`);
    ...
    return (
        <div className="p-4 md:p-8 bg-white min-h-screen overflow-x-hidden rounded-2xl shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 hidden">
                <div className="py-1">
